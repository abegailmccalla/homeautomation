...
#define BUTTON1 27 // Increment the currentDigit variable. If the variable becomes greater than 4, reset it to 1.
#define BUTTON2 26 // Invoke the checkPasscode function
#define BUTTON3 25 //  Set lockstate variable to false and invoke the showLockState function.
#define pm A3
#define TFT_DC    17
#define TFT_CS    5
#define TFT_RST   16
...
void checkPasscode(void){
    ...
    if(WiFi.status()== WL_CONNECTED){ 
      ...
      http.begin(client, "http://192.168.100.83:8080/api/check/combination"); // Your Domain name with URL path or IP address with path 
